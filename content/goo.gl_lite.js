...
goo_gl_lite = new function()
{
	...
	this.init = function()
	{
		document.getElementById("contentAreaContextMenu").addEventListener("popupshowing", handlePopupShowing, false);
		stringBundle = document.getElementById("goo_gl_lite_strings");
	};

	this.makeFromCurrentPage = function()
	{
		makeShortUrl(top.getBrowser().currentURI.spec);
	};

	this.makeFromLink = function()
	{
		makeShortUrl(gContextMenu.linkURL);
	};

	this.makeFromImageUrl = function()
	{
